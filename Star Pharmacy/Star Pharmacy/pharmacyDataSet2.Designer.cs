...
namespace Star_Pharmacy.pharmacyDataSet2TableAdapters {
    ...
    public partial class peopleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        people.*, ID AS Expr1, `First Name` AS Expr2, `Last Name` AS Expr3, Type AS Expr4, Address AS Expr5, `Date of Birth` AS Expr6, Salary AS Expr7, Username AS Expr8, Password AS Expr9, Branch AS Expr10, 
                         Working AS Expr11
FROM            people";
        ...
        public virtual int Fill(pharmacyDataSet2.peopleDataTable dataTable) {
        ...
        public virtual pharmacyDataSet2.peopleDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            pharmacyDataSet2.peopleDataTable dataTable = new pharmacyDataSet2.peopleDataTable();
